...
namespace InGreed_API.Migrations
{
    ...
    [Migration("20240609121654_AddedIdToReport")]
    partial class AddedIdToReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InGreed_API.Models.Ban", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InGreed_API.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InGreed_API.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("OpinionCreatorId")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InGreed_API.Models.ProductImage", b =>
                {
                    b.HasOne("InGreed_API.Models.Product", "Product")
                        .WithOne("Image")
                        .HasForeignKey("InGreed_API.Models.ProductImage", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
